...
const globalBundleCurrent = {
  pages: currentBundle.__global,
  app: currentBundle.__global_app
}
const globalBundleBase = {
  pages: baseBundle.__global,
  app: baseBundle.__global_app
}
delete currentBundle.__global
delete baseBundle.__global
delete currentBundle.__global_app
delete baseBundle.__global_app
